...
urlpatterns = [
    ...
    url(r'^task/view/image/(?P<id>[0-9]+)/(?P<q_id>[0-9]+)/$', my_views.view_task_image, name='view-image-task'),
    url(r'^task/view/choice/(?P<id>[0-9]+)/(?P<q_id>[0-9]+)/$', my_views.view_task_choice, name='view-choice-task'),
    url(r'^task/view/checkin/(?P<id>[0-9]+)/(?P<q_id>[0-9]+)/$', my_views.view_task_checkin, name='view-checkin-task'),
    ...
    url(r'^admin/edit/image/(?P<id>[0-9]+)/$', my_views.edit_image_task, name='edit-image-task'),
    url(r'^admin/edit/choice/(?P<id>[0-9]+)/$', my_views.edit_choice_task, name='edit-choice-task'),
    url(r'^admin/edit/checkin/(?P<id>[0-9]+)/$', my_views.edit_checkin_task, name='edit-checkin-task'),
